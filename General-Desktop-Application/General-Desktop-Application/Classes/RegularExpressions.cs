...
namespace General_Desktop_Application.Classes
{
    ...
    {
        public static bool CheckIsUsername(string stValue, int intMaximiumLength)
        {
            return Regex.IsMatch(stValue, @"^([0-9A-Za-z]+){4," + intMaximiumLength + "}$", RegexOptions.CultureInvariant);
        }

        public static bool CheckIsUsername(string stValue, int inMinimiumLength, int intMaximiumLength)
        {
        ...
        public static bool CheckIsFirstNameOrLastName(string stValue, int intMaximiumLength)
        {
            return Regex.IsMatch(stValue, @"^([A-Za-z\s,á,é,í,ó,ú,ñ,Á,É,Í,Ó,Ú,Ñ]+){1," + intMaximiumLength + "}$", RegexOptions.CultureInvariant);
        }

        public static bool CheckIsFirstNameOrLastName(string stValue, int inMinimiumLength, int intMaximiumLength)
        {
        ...
        public static bool ChecIskMoney(string stValue)
        {
        ...
        public static bool CheckIsPassword(string stValue)
        {
